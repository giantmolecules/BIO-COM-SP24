...
#define WLAN_SSID       "SAIC-Guest"
#define WLAN_PASS       "wifi@saic"
...
Adafruit_MQTT_Publish physarum = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/physarum");
...
void setup() {
  ...
  // Draw background and #
  //tft.drawBitmap(0, 0, epd_bitmap_psilocybe, 240, 135, ST77XX_YELLOW, ST77XX_BLACK);
